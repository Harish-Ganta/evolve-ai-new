      ...
      <div className="relative w-full max-w-5xl bg-white shadow-xl rounded-lg p-6 md:p-8">
        ...
        <div className="relative">
          ...
          <div className="absolute top-1/2 right-0 md:right-[-100px] transform -translate-y-1/2 bg-white p-4 md:p-6 rounded-lg shadow-md">
            <h3 className="text-xl font-bold text-headingText font-thicccboi leading-tight ">$49/month</h3>
            <p className="mt-3 text-[16px] text-paraText max-w-lg font-inter">Corporate Plan</p>
          </div>
        </div>        
        ...
        <div className="absolute top-[10rem] left-[-80px] md:left-[-100px] hidden md:block bg-white p-4 rounded-lg shadow-md">
          <p className="text-xl font-bold text-headingText font-thicccboi leading-tight ">Feature A</p>
          <p className="mt-3 text-[15px] text-paraText max-w-lg font-inter">Description of feature A.</p>
        </div>

        <div className="absolute bottom-[10rem] left-[-80px] md:left-[-100px] hidden md:block bg-white p-4 rounded-lg shadow-md">
          <p className="text-xl font-bold text-headingText font-thicccboi leading-tight ">Feature B</p>
          <p className="mt-3 text-[16px] text-paraText max-w-lg font-inter">Description of feature B.</p>
        </div>
      </div>
